...
class TestTranspositionRules:
    ...
    def test_conv2d_layout(self):
        from src.vggt.jax.weight_transfer import _conv2d_to_flax
    ...
    def test_conv_transpose2d_layout(self):
        from src.vggt.jax.weight_transfer import _conv_transpose2d_to_flax
    ...
    def test_linear_layout(self):
        from src.vggt.jax.weight_transfer import _linear_to_flax
...
def pytorch_ivggt_module():
    ...
    ext = str(
        Path(__file__).resolve().parents[2] / "external" / "InfiniteVGGT" / "src"
    )
...
class TestLevel2DinoV2Backbone:
    ...
    def test_patch_embed_conv_matches_pytorch(
        ...
        from src.vggt.jax.backbone import PatchEmbed
...
class TestLevel2AggregatorNoCache:
    ...
    def test_aggregator_last_level_matches_pytorch(
        ...
        import torch
        from src.vggt.jax.aggregator import Aggregator
...
class TestLevel2CameraHead:
    ...
    def test_camera_head_last_iter_matches_pytorch(
        ...
        import torch
        from src.vggt.jax.heads.camera_head import CameraHead
