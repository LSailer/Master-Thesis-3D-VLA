...
Run::
    ...
    uv run python -m modules.vggt.jax.profile_streaming --n-frames 10
    uv run python -m modules.vggt.jax.profile_streaming --n-frames 5 --trace /tmp/vggt_trace
...
from modules.vggt.jax.feature_extractor import (
