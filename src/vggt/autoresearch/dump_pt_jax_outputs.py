...
Notes
-----
- Both extractors (src.vggt.feature_extractor and
  src.vggt.jax.feature_extractor) expose a streaming `extract(rgb)` API
...
# Habitat discrete action indices (see src/environments/habitat.py ACTIONS dict):
