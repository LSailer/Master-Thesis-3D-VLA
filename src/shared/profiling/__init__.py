...
This package stays dependency-light on purpose. It can aggregate timings,
write plain artifacts, and synchronize generic pytree-like structures, but it
does not import JAX, Torch, Habitat, R2Dreamer, or VGGT internals.
"""
